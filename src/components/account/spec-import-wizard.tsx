    ...
    return (
      <div className="rounded-xl border border-dashed border-border bg-card p-10 text-center">
        ...
        <p className="mx-auto mt-2 max-w-sm text-sm text-muted-foreground">
          Колонки: артикул (опц.), наименование, количество, единица, производитель, напряжение
          (опц.), сечение (опц.). Заголовки на русском или английском — определим автоматически.
        </p>
        <input
          ref={fileInputRef}
          type="file"
