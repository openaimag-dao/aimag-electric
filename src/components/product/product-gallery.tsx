...
/**
 * Product gallery. Uses category-coded plates (crisp, on-brand) rather than
 * low-quality stock images. Large main view + selectable thumbnail strip.
 */
export function ProductGallery({
  ...
  const views = Array.from({ length: Math.max(1, count) });
